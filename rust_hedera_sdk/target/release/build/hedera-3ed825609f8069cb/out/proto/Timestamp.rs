...
impl ::protobuf::Message for TimestampSeconds {
    fn is_initialized(&self) -> bool {
        true
    }
    ...
    fn new() -> TimestampSeconds {
        TimestampSeconds::new()
    }
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeInt64>(
                    "seconds",
                    |m: &TimestampSeconds| { &m.seconds },
                    |m: &mut TimestampSeconds| { &mut m.seconds },
                ));
                ::protobuf::reflect::MessageDescriptor::new::<TimestampSeconds>(
                    "TimestampSeconds",
                    fields,
                    file_descriptor_proto()
                )
    ...
    fn default_instance() -> &'static TimestampSeconds {
        static mut instance: ::protobuf::lazy::Lazy<TimestampSeconds> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const TimestampSeconds,
        };
        unsafe {
            instance.get(TimestampSeconds::new)
        }
    }
}

impl ::protobuf::Clear for TimestampSeconds {
    fn clear(&mut self) {
        self.clear_seconds();
        self.unknown_fields.clear();
    }
...
impl ::std::fmt::Debug for TimestampSeconds {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for TimestampSeconds {
    fn as_ref(&self) -> ::protobuf::reflect::ProtobufValueRef {
        ::protobuf::reflect::ProtobufValueRef::Message(self)
    }
}
